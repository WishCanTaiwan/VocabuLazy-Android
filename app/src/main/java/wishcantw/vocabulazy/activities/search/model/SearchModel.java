package wishcantw.vocabulazy.activities.search.model;

import android.content.Context;
import android.support.annotation.NonNull;

import wishcantw.vocabulazy.database.DatabaseUtils;
import wishcantw.vocabulazy.activities.search.view.SearchDetailView;
import wishcantw.vocabulazy.activities.search.view.SearchListView;
...
public class SearchModel {
    ...
    public void storeData(@NonNull Context context) {
        database.storeData(context, false);
    }
}
