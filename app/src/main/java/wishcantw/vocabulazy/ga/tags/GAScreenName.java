package wishcantw.vocabulazy.ga.tags;

/**
 * Created by allencheng07 on 2016/9/24.
 *
 * Defines the screen names to be used while sending screen name event to Google Analytics.
 */
...
public class GAScreenName {
    ...
    // screen names in note
    public static final String SELECT_NOTE = "Select Note";
    ...
    // screen names in exam
    public static final String QUESTIONS = "Questions";
    public static final String RESULT = "Exam Result";

    // screen names in search
