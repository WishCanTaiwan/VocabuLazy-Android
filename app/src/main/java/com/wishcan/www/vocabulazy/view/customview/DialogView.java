 ...
 */
abstract public class DialogView extends LinearLayout {

    public interface OnYesOrNoClickedListener {
        void onYesClicked();

        void onNoClicked();
    }

    abstract public Object getDialogOutput();
    ...
    private LinearLayout.LayoutParams mDefaultDialogLayoutParams;

    private View mDialogView;

    private Context mContext;

    private OnYesOrNoClickedListener mListener;
    ...
    public DialogView(Context context, AttributeSet attrs) {
        ...
        mDefaultLayoutParams = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        setGravity(Gravity.CENTER);
        setVisibility(INVISIBLE);
        setBackgroundColor(DEFAULT_DIALOG_BACKGROUND_COLOR);
        setLayoutParams(mDefaultLayoutParams);

        mDefaultDialogLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public void setDialogTransition(LayoutTransition transition) {
        ...
        ValueAnimator translateAnim = ObjectAnimator.ofFloat(mDialogView, "TranslationY", 1920f, 0f);
    ...
    public void setOnYesOrNoClickedListener(OnYesOrNoClickedListener listener) {
        mListener = listener;
    }
