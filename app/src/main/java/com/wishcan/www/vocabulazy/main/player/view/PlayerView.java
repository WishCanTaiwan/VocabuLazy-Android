 ...
 */
public class PlayerView extends Infinite3View {

    interface OnPlayerScrollStopListener{
        void onPlayerScrollStop();
    }
    ...
    private static OnPlayerScrollStopListener mOnPlayerScrollStopListener;
    ...
    public void addNewPlayer(LinkedList<HashMap> playerDataList){
        ...
        refreshItem(Infinite3View.CENTER_VIEW_INDEX, mPlayerScrollView);
    }
    ...
    public void setOnPlayerScrollStopListener(OnPlayerScrollStopListener listener){
        mOnPlayerScrollStopListener = listener;
    }

    public static class PlayerScrollView extends PopScrollView {

        public static final int PLAYER_ITEM_LAYOUT_RES_ID = R.layout.player_layout;
        ...
        public static final int PLAYER_ITEM_DETAIL_LAYOUT_RES_ID = R.layout.player_layout_details;
        ...
        public PlayerScrollView(Context context) {
            super(context);
            mPlayerDetailView = null;
            setOnPopScrollStoppedListener(new OnPopScrollStoppedListener() {
                @Override
                public void onPopScrollStopped() {
                    if(mOnPlayerScrollStopListener != null)
                        mOnPlayerScrollStopListener.onPlayerScrollStop();
        ...
        private class PlayerDetailView extends LinearLayout {
            ...
            private class PopItemDetailAdapter{
                ...
                public void setChildViewToGroup(){
                    ...
                    ViewGroup itemView = (ViewGroup) mInflater.inflate(R.layout.player_layout_details, null);
                    ...
                    for(int i = 0; i < pageCount; i++) {
                        ViewGroup currentItemDetailsView =
                                (ViewGroup)((LayoutInflater) getContext()
                                        ...
                                        .inflate(PLAYER_ITEM_DETAIL_LAYOUT_RES_ID, null);

                        ((TextView) currentItemDetailsView
                                .findViewById(PLAYER_ITEM_CONTENT_ID_s.VOC_SENTENCE_DETAIL.getValue()))
                                .setText(en_sentenceList.get(i));
                        ((TextView) currentItemDetailsView
                                .findViewById(PLAYER_ITEM_CONTENT_ID_s.VOC_SENTENCE_TRANSLATION_DETAIL.getValue()))
