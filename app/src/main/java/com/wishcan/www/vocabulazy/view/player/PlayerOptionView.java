...
import com.wishcan.www.vocabulazy.view.picker.NumeralPicker;
...
public class PlayerOptionView extends LinearLayout {
    ...
    private static final String TAG = PlayerOptionView.class.getSimpleName();
...
//        Log.d(TAG, "Constructor");
        ...
        mTabContent0.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        mTabContent1.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        ...
        mTabContent2.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
...
//        Log.d(TAG, "setOptionInTabContent: " + mode);
        ...
        if(v instanceof ImageView)
            ...
            switch (optionID) {
                case PLAYER_OPTION_SECOND_PICKER_RES_ID:
//                    picker.setMaximumNumber(9);
//                    picker.setMinimumNumber(0);
                    picker.calculatePickerRange();
                    picker.setPickerTextStr(String.valueOf(option));
                    break;
                case PLAYER_OPTION_FREQUENCY_PICKER_RES_ID:
//                    picker.setMaximumNumber(5);
//                    picker.setMinimumNumber(1);
                    picker.calculatePickerRange();
                    picker.setPickerTextStr(String.valueOf(option));
                    break;
                case PLAYER_OPTION_SPEED_PICKER_RES_ID:
//                    picker.setMaximumNumber(2);
//                    picker.setMinimumNumber(1);
                    picker.calculatePickerRange();
                    picker.setPickerTextStr(String.valueOf(option));
                    break;
                case PLAYER_OPTION_PLAY_TIME_PICKER_RES_ID:
//                    picker.setMaximumNumber(1);
//                    picker.setMinimumNumber(0);
                    picker.calculatePickerRange();
                    picker.setPickerTextStr(String.valueOf(option));
                    break;
...
//        Log.d(TAG, "setCurrentTab " + mCurrentTabIndex);
    ...
    private void initAllLayout(){
        ...
        mTabContentLayout.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
